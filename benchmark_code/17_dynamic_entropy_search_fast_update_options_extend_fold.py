...
dynamic_entropy_search=DynamicEntropySearch(path_data=path_data_dynamic, num_per_group=num_per_group, cache_list_threshold=cache_list_threshold, extend_fold=extend_fold)
