...
if step=="build":
    ...
    for i in range(file_num):
        ...
        dynamic_entropy_search.add_new_spectra(spec, insert_mode='fast_search',convert_to_flash=False)
    
    dynamic_entropy_search.build_index(insert_mode='fast_search', convert_to_flash=False)
