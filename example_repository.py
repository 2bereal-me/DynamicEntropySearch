...
def main():
    search_engine = RepositorySearch(path_data='/data/your_download_repository') # Replace this path with your repository path of prebuilt indexes. See README.md for more details.
    file_mzml_1 = '/data/CUDA-pos-02.mzML'
    file_mzml_2 = '/data/serum-pos-01.mzML'
